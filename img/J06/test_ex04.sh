...
/*   Updated: 2019/01/19 16:04:22 by idcornua         ###   ########.fr       */
#                                                                              #
# **************************************************************************** #
...
do
	...
	if [ "$i" == "5" ];then
		echo "$> ./J${J}_ex${E}_exe \"coucou\" "alors\" \"aaaaba\" \"artichot\" \"triche\" \"aaaaca\" \"zimbawe\" "truth\" \"aaaaaa\" > m_output"
		echo "$> ./${U_EX} \"coucou\" "alors\" \"aaaaba\" \"artichot\" \"triche\" \"aaaaca\" \"zimbawe\" "truth\" \"aaaaaa\" > u_output"
		echo "\n$>diff -U 10 u_output m_output > m_diff\n"

    	./J${J}_ex${E}_exe "coucou" "alors" "aaaaba" "artichot" "triche" "aaaaca" "zimbawe" "truth" "aaaaaa" > m_output
		./${U_EX} "coucou" "alors" "aaaaba" "artichot" "triche" "aaaaca" "zimbawe" "truth" "aaaaaa" > u_output
	fi
	if [ "$i" == "6" ];then
		echo "$> ./J${J}_ex${E}_exe \"s\" \"d\" \"detritus\" \"abris\" \"r\" \"Detruit\" \"abri\"\"m\" \"e\" \"t\" \"detruit\" \"z\" \"Abris\" \"a\" \"h\" \"Abri\" \"w\" \"G\" \"K\" \"Detritus\" \"A\" \"Z\" \"M\" \"Abricot\" \"X\" \"S\" \"R\" \"abricot\" > m_output"
		echo "$> ./${U_EX} \"s\" \"d\" \"detritus\" \"abris\" \"r\" \"Detruit\" \"abri\"\"m\" \"e\" \"t\" \"detruit\" \"z\" \"Abris\" \"a\" \"h\" \"Abri\" \"w\" \"G\" \"K\" \"Detritus\" \"A\" \"Z\" \"M\" \"Abricot\" \"X\" \"S\" \"R\" \"abricot\" > u_output"
		echo "\n$>diff -U 10 u_output m_output > m_diff\n"

    	./J${J}_ex${E}_exe "s" "d" "detritus" "abris" "r" "Detruit" "abri" "m" "e" "t" "detruit" "z" "Abris" "a" "h" "Abri" "w" "G" "K" "Detritus" "A" "Z" "M" "Abricot" "X" "S" "R" "abricot" > m_output
		./${U_EX} "s" "d" "detritus" "abris" "r" "Detruit" "abri" "m" "e" "t" "detruit" "z" "Abris" "a" "h" "Abri" "w" "G" "K" "Detritus" "A" "Z" "M" "Abricot" "X" "S" "R" "abricot" > u_output
	fi
