...
#    Updated: 2019/01/23 11:11:04 by idcornua         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
gcc -o ${U_EX} ${FLAGS} m_ex${E}.c ${COM} ~/${J_PATH}/ex04/ft_split_whitespaces.c ~/${J_PATH}/ex${E}/${EX} 2> error_log
ERROR=`cat error_log`
if [ "${ERROR}" != "" ]
then
	echo "${ERROR}"
